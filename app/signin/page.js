            ...
            <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg">
                <form className="flex flex-col gap-3">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center border border-gray-200 rounded-lg px-3 h-12 focus-within:border-blue-500 transition-colors">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="flex items-center border border-gray-200 rounded-lg px-3 h-12 focus-within:border-blue-500 transition-colors">
                            ...
                            <input
                                ...
                                className="ml-2 h-full w-full outline-none"
                            />
                            <svg viewBox="0 0 576 512" height="1em" xmlns="http://www.w3.org/2000/svg" className="text-gray-500 cursor-pointer">
                    ...
                    <button
                        type="button"
                        className="bg-gray-900 hover:bg-gray-800 text-white py-3 px-4 rounded-lg mt-4 font-medium transition-colors"
                    >
                        Sign In
                    </button>

                    {/* Sign Up Option */}
                    <p className="text-sm text-center text-gray-700 my-2">
                    ...
                    <div className="flex items-center my-2">
                        ...
                        <p className="mx-4 text-sm text-gray-500">Or With</p>
                        <div className="flex-grow h-px bg-gray-200"></div>
                    </div>
